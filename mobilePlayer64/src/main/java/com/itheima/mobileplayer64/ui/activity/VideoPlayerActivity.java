...
import com.itheima.mobileplayer64.view.VideoView;
...
//			logE("VideoPlayerActivity.onReceive.level="+level);
	...
	private final class OnVideoPreparedListener implements
		...
		public void onPrepared(MediaPlayer mp) {
			...
			// 初始化时间进度
			tv_duration.setText(StringUtils.formartDuration(mp.getDuration()));
			sk_position.setMax(mp.getDuration());
